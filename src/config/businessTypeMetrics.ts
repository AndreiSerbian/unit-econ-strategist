...
export const businessTypes: BusinessTypeConfig[] = [
  ...
  },
  {
    ...
    productFields: [
      { key: 'name', label: 'Название', labelKey: 'businessTypeMetrics.field_name', type: 'text', required: true },
      { key: 'price', label: 'Цена', labelKey: 'businessTypeMetrics.field_price', type: 'number' },
      { key: 'cost', label: 'Себестоимость', labelKey: 'businessTypeMetrics.field_cost', type: 'number' },
      { key: 'quantity', label: 'Количество', labelKey: 'businessTypeMetrics.field_quantity', type: 'number' },
      { key: 'quality', label: 'Качество', labelKey: 'businessTypeMetrics.field_quality', type: 'number', min: 1, max: 20 },
      { key: 'logisticsToClientPerUnit', label: 'Логистика до клиента', labelKey: 'businessTypeMetrics.field_logisticsToClient', type: 'number', suffix: 'за 1 шт.', suffixKey: 'businessTypeMetrics.suffix_per_unit' },
      { key: 'weightPerUnit', label: 'Вес', labelKey: 'businessTypeMetrics.field_weight', type: 'number', suffix: 'кг', suffixKey: 'businessTypeMetrics.suffix_kg' },
      { key: 'volumePerUnit', label: 'Объём', labelKey: 'businessTypeMetrics.field_volume', type: 'number', suffix: 'м³', suffixKey: 'businessTypeMetrics.suffix_m3' },
      { key: 'deliveryType', label: 'Тип доставки', labelKey: 'businessTypeMetrics.field_deliveryType', type: 'select', options: DELIVERY_TYPE_OPTIONS },
    ],
    metricFields: [
  ...
  },
  {
    ...
    productFields: [
      ...
      { key: 'price', label: 'Цена', labelKey: 'businessTypeMetrics.field_price', type: 'number' },
      { key: 'cost', label: 'Себестоимость', labelKey: 'businessTypeMetrics.field_cost', type: 'number' },
      { key: 'quantity', label: 'Объём производства', labelKey: 'businessTypeMetrics.production_field_quantity', type: 'number' },
      { key: 'quality', label: 'Качество', labelKey: 'businessTypeMetrics.field_quality', type: 'number', min: 1, max: 20 },
      { key: 'defectRate', label: 'Процент брака', labelKey: 'businessTypeMetrics.field_defectRate', type: 'number', suffix: '%', suffixKey: 'businessTypeMetrics.suffix_percent', min: 0, max: 100 },
      { key: 'logisticsToClientPerUnit', label: 'Логистика до клиента', labelKey: 'businessTypeMetrics.field_logisticsToClient', type: 'number', suffix: 'за 1 шт.', suffixKey: 'businessTypeMetrics.suffix_per_unit' },
      { key: 'weightPerUnit', label: 'Вес', labelKey: 'businessTypeMetrics.field_weight', type: 'number', suffix: 'кг', suffixKey: 'businessTypeMetrics.suffix_kg' },
      { key: 'volumePerUnit', label: 'Объём', labelKey: 'businessTypeMetrics.field_volume', type: 'number', suffix: 'м³', suffixKey: 'businessTypeMetrics.suffix_m3' },
      { key: 'deliveryType', label: 'Тип доставки', labelKey: 'businessTypeMetrics.field_deliveryType', type: 'select', options: DELIVERY_TYPE_OPTIONS },
